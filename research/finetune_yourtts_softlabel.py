...
# 실행을 위한 이름
RUN_NAME = "YourTTS-ko-ft-softlabel-ckp28"

# 모델 출력(구성, 체크포인트, 텐서보드 로그)을 저장할 경로
OUT_PATH = '/data2/personal/sungjin/korean_standard'  # "/raid/coqui/Checkpoints/original-YourTTS/"

CONTINUE_PATH = '/data2/personal/sungjin/korean_standard/YourTTS-ko-ft-softlabel-ckp28-February-24-2025_07+58AM-165e9d5a'
...
phoneme_cache_folder_path = '/home/research/phoneme_cache_ft_softlabel_ckp28'
...
# 학습기 초기화 및 🚀 시작
trainer = Trainer(
    #TrainerArgs(restore_path='/data2/personal/sungjin/korean_standard/YourTTS-ko-standard-February-16-2025_12+40PM-165e9d5a/checkpoint_740000.pth', gpu=0), # gpu번호 설정
