...
# 실행을 위한 이름
RUN_NAME = "YourTTS-ko-ft-onehot"

# 모델 출력(구성, 체크포인트, 텐서보드 로그)을 저장할 경로
OUT_PATH = '/data2/personal/sungjin/korean_standard'  # "/raid/coqui/Checkpoints/original-YourTTS/"

CONTINUE_PATH = '/data2/personal/sungjin/korean_standard/YourTTS-ko-ft-onehot-February-21-2025_08+33AM-165e9d5a'
...
phoneme_cache_folder_path = '/home/research/phoneme_cache_ft_onehot'
...
# 학습기 초기화 및 🚀 시작
trainer = Trainer(
    TrainerArgs(continue_path=CONTINUE_PATH, gpu=0), # gpu번호 설정
    config,  # 모델 구성
